...
- (void)startRawData {
  NSLog(@"startRawData");
  [_fibrichecker startRawData];
}

- (void)stopRawData {
  NSLog(@"stopRawData");
  [_fibrichecker stopRawData];
}
...
- (void)addListeners {
  ...
  self.fibrichecker.onMeasurementStart = ^{
      ...
      RCTLogInfo(@"Measurement started at: %lu", currentTime);
    NSDictionary *data =
      @{@"timestamp" : [NSNumber numberWithLongLong:currentTime]};
    dispatch_async(dispatch_get_main_queue(), ^{
      if (((RNTFibriCheckView *)weakSelf.view).onMeasurementStart != nil)
        ((RNTFibriCheckView *)weakSelf.view).onMeasurementStart(data);
    });
  };

  self.fibrichecker.onMeasurementFinished = ^{
      long currentTime = (long)(NSTimeInterval)([[NSDate date] timeIntervalSince1970]);
    RCTLogInfo(@"Measurement Finished at: %lu", currentTime);
    NSDictionary *data =
        @{@"timestamp" : [NSNumber numberWithLongLong:currentTime]};
    dispatch_async(dispatch_get_main_queue(), ^{
      if (((RNTFibriCheckView *)weakSelf.view).onMeasurementFinished != nil)
        ((RNTFibriCheckView *)weakSelf.view).onMeasurementFinished(data);
    });
  };
  ...
  self.fibrichecker.onMeasurementProcessed = ^(Measurement *measurement) {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
      if (((RNTFibriCheckView *)weakSelf.view).onMeasurementProcessed != nil)
        ((RNTFibriCheckView *)weakSelf.view).onMeasurementProcessed(data);
    });
  };
  ...
  self.fibrichecker.onSampleReady = ^(double ppg, double raw) {
    ...
    NSDictionary *data = @{
      @"ppg" : [NSNumber numberWithFloat:ppg],
      @"raw" : [NSNumber numberWithFloat:raw]
    };
    dispatch_async(dispatch_get_main_queue(), ^{
      if (((RNTFibriCheckView *)weakSelf.view).onSampleReady != nil)
        ((RNTFibriCheckView *)weakSelf.view).onSampleReady(data);
    });
  };
  ...
  self.fibrichecker.onCalibrationReady = ^{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
      if (((RNTFibriCheckView *)weakSelf.view).onCalibrationReady != nil)
        ((RNTFibriCheckView *)weakSelf.view).onCalibrationReady(@{});
    });
  };
  ...
  self.fibrichecker.onFingerRemoved = ^(double y, double v, double stdDevY) {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
      if (((RNTFibriCheckView *)weakSelf.view).onFingerRemoved != nil)
        ((RNTFibriCheckView *)weakSelf.view).onFingerRemoved(data);
    });
  };
  ...
  self.fibrichecker.onFingerDetected = ^{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
      if (((RNTFibriCheckView *)weakSelf.view).onFingerDetected != nil)
        ((RNTFibriCheckView *)weakSelf.view).onFingerDetected(@{});
    });
  };
  ...
  self.fibrichecker.onMovementDetected = ^{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
      if (((RNTFibriCheckView *)weakSelf.view).onMovementDetected != nil)
        ((RNTFibriCheckView *)weakSelf.view).onMovementDetected(@{});
    });
  };
  ...
  self.fibrichecker.onPulseDetected = ^{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
      if (((RNTFibriCheckView *)weakSelf.view).onPulseDetected != nil)
        ((RNTFibriCheckView *)weakSelf.view).onPulseDetected(@{});
    });
  };
  ...
  self.fibrichecker.onPulseDetectionTimeExpired = ^{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
      if (((RNTFibriCheckView *)weakSelf.view).onPulseDetectionTimeExpired !=
          nil)
        ((RNTFibriCheckView *)weakSelf.view).onPulseDetectionTimeExpired(@{});
    });
  };
  ...
  self.fibrichecker.onFingerDetectionTimeExpired = ^{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
      if (((RNTFibriCheckView *)weakSelf.view).onFingerDetectionTimeExpired !=
          nil)
        ((RNTFibriCheckView *)weakSelf.view).onFingerDetectionTimeExpired(@{});
    });
  };
  ...
  self.fibrichecker.onHeartBeat = ^(NSUInteger value) {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
      if (((RNTFibriCheckView *)weakSelf.view).onHeartBeat != nil)
        ((RNTFibriCheckView *)weakSelf.view).onHeartBeat(data);
    });
  };
  ...
  self.fibrichecker.onTimeRemaining = ^(NSUInteger seconds) {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
      if (((RNTFibriCheckView *)weakSelf.view).onTimeRemaining != nil)
        ((RNTFibriCheckView *)weakSelf.view).onTimeRemaining(data);
    });
  };
  ...
  self.fibrichecker.onMeasurementError = ^(NSString *message) {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
      if (((RNTFibriCheckView *)weakSelf.view).onMeasurementError != nil)
        ((RNTFibriCheckView *)weakSelf.view).onMeasurementError(data);
    });
  };

  self.fibrichecker.onRawData =
      ^(NSData *rawData,
        NSDictionary<NSString *, NSString *> *_Nonnull metaData) {
          NSString *imageString = rawData ? [rawData base64EncodedStringWithOptions:0] : @"";
          ...
          dispatch_async(dispatch_get_main_queue(), ^{
            if (((RNTFibriCheckView *)weakSelf.view).onRawData != nil)
              ((RNTFibriCheckView *)weakSelf.view).onRawData(event);
          });
      };
}
